...
//        Imgproc.erode_Y(img, img, Imgproc.getStructuringElement(Imgproc.MORPH_RECT, new Size(2, 2)), new Point(-1, -1), 3);
        Imgproc.dilate(img, img, Imgproc.getStructuringElement(Imgproc.MORPH_RECT, new Size(3, 3)), new Point(-1, -1), 3);
        Mat onelayer = new Mat();
    ...
    public static Mat Tile_erode(Mat img) {
        Imgproc.erode(img, img, Imgproc.getStructuringElement(Imgproc.MORPH_RECT, new Size(20, 20)), new Point(-1, -1), 1);
        Mat onelayer = new Mat();
...
//        Imgproc.erode_Y(img, img, Imgproc.getStructuringElement(Imgproc.MORPH_RECT, new Size(2, 2)), new Point(-1, -1), 3);
        Imgproc.dilate(img, img, Imgproc.getStructuringElement(Imgproc.MORPH_RECT, new Size(5, 5)), new Point(-1, -1), 3);
        Mat onelayer = new Mat();
        Core.inRange(img, new Scalar(250), new Scalar(255), onelayer);
        img.copyTo(img, onelayer);
        return img;
    ...
    public static Mat Tile_erode2(Mat img) {
        Imgproc.erode(img, img, Imgproc.getStructuringElement(Imgproc.MORPH_RECT, new Size(7, 7)), new Point(-1, -1), 1);
        Mat onelayer = new Mat();
        Core.inRange(img, new Scalar(253), new Scalar(255), onelayer);
        img.copyTo(img, onelayer);
        return img;
